...
void add(string *chaine_dest, char c){
    if(sizeof(chaine_dest->str) == sizeof(char)*chaine_dest->N) {
        char* nouv_chaine = realloc(chaine_dest->str, sizeof(char)*(chaine_dest->N+1));
        if(nouv_chaine == NULL)
            return;
            
        chaine_dest->str = nouv_chaine;
    }
...
void delete(string *chaine_dest, int i){
    ...
    if(sizeof(chaine_dest->str) > chaine_dest->N*2) {
        char* nouv_chaine = realloc(chaine_dest->str, sizeof(char)*chaine_dest->N);
        if(nouv_chaine == NULL)
            return;
